...
class GlobalScreenshot {
     ...
     */
    void takeScreenshot(Context context, View view, Runnable finisher, boolean statusBarVisible, boolean navBarVisible) {
        // Take the screenshot
        ...
        // save
        BitmapUtil.saveBitmap(context, mScreenBitmap, "screenshot");
